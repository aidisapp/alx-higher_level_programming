...
class TestBase_instantiation(unittest.TestCase):
    """Unittests for instantiating the Base class."""
...
class TestBase_load_from_file(unittest.TestCase):
    """Unit tests for the load_from_file_method of the Base class."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unit tests for the save_to_file_csv method of the Base class."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Unittests for the load_from_file_csv method of the Base class."""
