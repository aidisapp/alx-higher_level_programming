...
class TestSquare_instantiation(unittest.TestCase):
    """Unit tests for instantiating the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unit tests for size initializing the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unit tests for initializing the Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unit tests for initializing the Square y attribute."""
...
class TestSquare_area(unittest.TestCase):
    """Unit tests for the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unit tests for the __str__ and display methods of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unit tests for the _dictionary method of the Square class."""
